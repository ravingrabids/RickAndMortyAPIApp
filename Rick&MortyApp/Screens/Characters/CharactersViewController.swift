...
class CharactersViewController: UIViewController {
    ...
    //Variables
    private var dataSource: UICollectionViewDiffableDataSource<Section, PersonCharacter>!
...
extension CharactersViewController: UICollectionViewDelegate {
    ...
    private func configureDataSource(){
        dataSource = UICollectionViewDiffableDataSource<Section, PersonCharacter>(collectionView: collectionView) {(collectionView, indexPath, characterModel) -> UICollectionViewCell? in
    ...
    private func createSnapshot(from addedCharacters: [PersonCharacter]) {
        var snapshot = NSDiffableDataSourceSnapshot<Section, PersonCharacter>()
